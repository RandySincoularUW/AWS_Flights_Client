...
if (myLatitude == null || myLongitude == null) {
    ...
    // Can't use process.env in client
    // myLatitude = process.env.defaultLatitude
    // myLongitude = process.env.defaultLongitude
}
...
const getFlights = async function (airportCode)  {
    ...
    try {
        ...
        if (typeof airportCode == 'undefined') {
            ...
            // Error. process.env not allowed in client code
            // airportCode = process.env.defaultAirportCode
